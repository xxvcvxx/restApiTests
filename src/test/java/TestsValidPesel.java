...
public class TestsValidPesel {
    ...
    public void validPeselTestStatusCodeCheck(String pesel, String description) {
        ...
        Response response = RestAssured.get("http://pesel.eu-central-1.elasticbeanstalk.com/api/v1/pesel/" + pesel);
    ...
    public void validPeselDateOfBirth(String pesel, String description) {
        ...
        Response response = RestAssured.get("http://pesel.eu-central-1.elasticbeanstalk.com/api/v1/pesel/" + pesel);
        String[] words = description.split("\\s+");
        String expectedDateOfBirth = words[1].toUpperCase();
